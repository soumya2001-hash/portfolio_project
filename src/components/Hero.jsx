    ...
    <div className='border-b border-neutral-900 pb-4 lg:mb-16'>
      <div className='flex flex-wrap '>
            ...
            <div className='flex flex-col items-center lg:items-start'>
                ...
                initial="hidden"
                animate="visible"
                className='pb-8 text-4xl lg:text-6xl font-thin tracking-tight leading-tight'>
                Soumya Hegde
                </motion.h1>
                <motion.span 
                ...
                initial="hidden"
                animate="visible"
                className='my-2 max-w-xl py-6 font-light tracking-widest'>
                {HERO_CONTENT}
                </motion.p>
            </div>
            </div>
            <div className='w-full lg:w-1/2 lg:p-8'>
                <div className='flex justify-center '>
                    ...
                    src={profile} alt="profile picture" className='rounded-2xl'/>
                </div>
            </div>
      </div>
    </div>
